...
const links = [
  { to: '/',              label: 'Collection', icon: IconCollection },
  { to: '/wishlist',      label: 'Wishlist',   icon: IconHeart },
  { to: '/scan',          label: 'Scanner',    icon: IconScan },
  { to: '/shared-views',  label: 'Amis',       icon: IconFriends },
...
export function BottomNav() {
  return (
    <nav
      className="fixed bottom-0 inset-x-0 z-40 bg-slate-900/95 backdrop-blur
                 border-t border-slate-800 flex items-stretch justify-around
    ...
    >
      {links.map(({ to, label, icon: Icon }) => (
        <NavLink
          ...
          className={({ isActive }) =>
            `flex flex-col items-center justify-center gap-0.5 py-2 px-2 text-[11px]
